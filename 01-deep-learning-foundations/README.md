...
This section covers the architecture concepts grouped under **Deep Learning Foundations**.

## Core Idea

This chapter introduces the central ideas behind deep learning foundations. Read the linked pages as a progression from the problem being solved, to the mechanism that solves it, to the trade-offs that appear in real systems. The goal is to understand not only what a model is called, but what computation it performs and why that computation is useful.
...
- [Neurons Mlps And Representations](neurons-mlps-and-representations.md)
- [Backpropagation And Optimization](backpropagation-and-optimization.md)
- [Embeddings](embeddings.md)
- [Normalization And Residual Connections](normalization-and-residual-connections.md)
