...
This section covers the architecture concepts grouped under **Navigation and Methodology**.

## Core Idea

This chapter introduces the central ideas behind navigation and methodology. Read the linked pages as a progression from the problem being solved, to the mechanism that solves it, to the trade-offs that appear in real systems. The goal is to understand not only what a model is called, but what computation it performs and why that computation is useful.
...
- [Architecture Selection Method](architecture-selection-method.md)
- [Evolution Of Ai Architectures](evolution-of-ai-architectures.md)
