...
This section covers the architecture concepts grouped under **Reusable Architecture Patterns**.

## Core Idea

This chapter introduces the central ideas behind reusable architecture patterns. Read the linked pages as a progression from the problem being solved, to the mechanism that solves it, to the trade-offs that appear in real systems. The goal is to understand not only what a model is called, but what computation it performs and why that computation is useful.
...
- [Encoder And Decoder](encoder-and-decoder.md)
- [Attention](attention.md)
- [Recurrence And State](recurrence-and-state.md)
- [Routing And Conditional Computation](routing-and-conditional-computation.md)
- [Latent Prediction](latent-prediction.md)
- [Memory](memory.md)
- [Hierarchy And Modularity](hierarchy-and-modularity.md)
