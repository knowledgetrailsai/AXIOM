...
Use `templates/architecture-page-template.md`.

Start simple, then cover information flow, compute/memory characteristics, strengths, limitations, comparisons and primary references.

Prefer primary papers and official research pages. Clearly separate reported empirical claims from interpretation.
