...
This section covers the architecture concepts grouped under **Classical Neural Architectures**.

## Core Idea

This chapter introduces the central ideas behind classical neural architectures. Read the linked pages as a progression from the problem being solved, to the mechanism that solves it, to the trade-offs that appear in real systems. The goal is to understand not only what a model is called, but what computation it performs and why that computation is useful.
...
- [Rnn Lstm Gru](rnn-lstm-gru.md)
- [Encoder Decoder Seq2Seq](encoder-decoder-seq2seq.md)
