...
This section covers the architecture concepts grouped under **Generative Model Architectures**.

## Core Idea

This chapter introduces the central ideas behind generative model architectures. Read the linked pages as a progression from the problem being solved, to the mechanism that solves it, to the trade-offs that appear in real systems. The goal is to understand not only what a model is called, but what computation it performs and why that computation is useful.
...
- [Autoencoders Vae Vqvae](autoencoders-vae-vqvae.md)
- [Gans](gans.md)
- [Diffusion Models](diffusion-models.md)
- [Diffusion Transformers](diffusion-transformers.md)
- [Flows And Flow Matching](flows-and-flow-matching.md)
- [Autoregressive Vs Diffusion Vs Flow](autoregressive-vs-diffusion-vs-flow.md)
