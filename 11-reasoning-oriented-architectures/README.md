...
This section covers the architecture concepts grouped under **Reasoning-Oriented Architectures**.

## Core Idea

This chapter introduces the central ideas behind reasoning-oriented architectures. Read the linked pages as a progression from the problem being solved, to the mechanism that solves it, to the trade-offs that appear in real systems. The goal is to understand not only what a model is called, but what computation it performs and why that computation is useful.
...
- [Reasoning As Computation](reasoning-as-computation.md)
- [Recurrent And Iterative Reasoning](recurrent-and-iterative-reasoning.md)
- [Latent Reasoning](latent-reasoning.md)
- [Generator Verifier](generator-verifier.md)
- [Test Time Compute And Planning](test-time-compute-and-planning.md)
